...
// Adapted from: https://stackoverflow.com/a/37707741
public class SnackbarWrapper {
    ...
    @NonNull
    public static SnackbarWrapper make(@NonNull Context applicationContext, @NonNull CharSequence text, int duration)
    {
        return new SnackbarWrapper(applicationContext, text, duration);
    }

    private SnackbarWrapper(@NonNull final Context appplicationContext, @NonNull CharSequence text, int duration)
    {
    ...
    public void show()
    {
        // TODO: null windowToken causes problems on some devices
        // TODO: TYPE_TOAST will not work on Oreo
    ...
    {
        final CoordinatorLayout snackbarContainer = new CoordinatorLayout(new ContextThemeWrapper(appplicationContext, R.style.Theme_SnackbarWrapper))
        {
            @Override
